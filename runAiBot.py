        ...
        try:
            while current_count < switch_number:
                ...
                for job in job_listings:
                    ...
                    # 🔥 Select resume based on job title
                    
                    try:
                        selected_resume = select_resume(title)
                        print_lg(f"[Resume Selector] Using resume: {selected_resume}")
                    except Exception as e:
                        print_lg("Resume selection failed, using default.", e)
                        ...
                        try: 
                            try:
                                ...
                                while next_button:
                                    ...
                                    if useNewResume and not uploaded: uploaded, resume = upload_resume(modal, selected_resume)
...
def main() -> None:
    pyautogui.alert("Starting Auto Job Applier 🚀", "Info", "OK")
    total_runs = 1
    try:
