"""
This module contains all the prompts and response formats used for interacting with the Gemini API in the Auto Job Applier project. 
It defines structured prompts for various tasks such as extracting skills from job descriptions and answering questions, as well as the expected response formats to ensure consistent and accurate communication with the AI model.
"""
